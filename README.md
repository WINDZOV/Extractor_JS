...
XTRCT is a static page for extracting compressed archives directly in the browser.

## What it does
- Loads ZIP, TAR, TAR.GZ, TAR.BZ2, TAR.XZ, GZ, BZ2, and XZ archives.
...
## Features
- Dark UI with animations and layered visual depth.
...
## Files
- `extractor.html` — the main and only page.

## License
This project is a demo for personal and presentation use.
